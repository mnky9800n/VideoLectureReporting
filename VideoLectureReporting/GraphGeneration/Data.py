...
class Data:
    ...
    def __init__(self, db_conn):
        self.engine = db_conn
        self.raw_data = pd.read_sql("SELECT * FROM [Video Views]", self.engine)
    ...
    def timeline_df(self):
        ...
        """
        This function returns the count per day
        of Lab videos viewed and Lecture videos
        viewed.
        ...
        def _pivot_query(labs):
            """
            This is a nested function so as not to
            write the query twice.
